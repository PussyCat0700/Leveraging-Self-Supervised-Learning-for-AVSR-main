...
--modal AV \
--decode_type HYBRID \
--logname /data2/alumni/gryang/Leveraging-Self-Supervised-Learning-for-AVSR-main_noneed/decode_AV_drop0.5wd0.01/hybrid_bs_48_1.txt \
--beamWidth 5 \
--batch_size 48 \
--beta 0 \
--nbest 30 \
...
#nohup bash decode_AV_drop0.5wd0.01/decode_hybrid1.sh &