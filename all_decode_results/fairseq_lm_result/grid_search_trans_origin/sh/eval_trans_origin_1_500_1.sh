...
python eval.py \
--type fairseqlm \
--logname /mnt/lustre/sjtu/data2/alumni/gry10/Leveraging-Self-Supervised-Learning-for-AVSR-main/lrs3_trans_origin_1_500_1.txt \
...
#nohup bash grid_search_trans_origin/sh/eval_trans_origin_1_500_1.sh > eval_trans_origin_1_500_1.log &