...
#SBATCH --output=eval_hybridrescore_AV.out
#SBATCH --error=eval_hybridrescore_AV.err
...
--logname /data1/yfliu/Leveraging-Self-Supervised-Learning-for-AVSR-main_noneed/beam40_AV/ao_0.8.txt \
--beamWidth 40 \
--batch_size 48 \
--beta 0.8 \
--nbest 30