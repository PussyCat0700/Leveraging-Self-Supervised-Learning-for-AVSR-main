...
def main():
    ...
    trainer.fit(model, LRS2Dataloader,ckpt_path="/home/gryang/Leveraging-Self-Supervised-Learning-for-AVSR-main/check925/train-step_0107-wer_0.058.ckpt")
    #trainer.fit(model, LRS2Dataloader,ckpt_path="/home/gryang/Leveraging-Self-Supervised-Learning-for-AVSR-main/train-step_0006-wer_0.065.ckpt")
    #trainer.fit(model, LRS2Dataloader,ckpt_path="/home/gryang/Leveraging-Self-Supervised-Learning-for-AVSR-main/train-step_0011-wer_0.069.ckpt")
    #trainer.fit(model, LRS2Dataloader,ckpt_path="/home/gryang/Leveraging-Self-Supervised-Learning-for-AVSR-main/train-step_0123-wer_0.062.ckpt")
