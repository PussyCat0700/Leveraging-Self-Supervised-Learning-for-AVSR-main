...
# args["NOISE_FILE"] = "LRS2/mvlrs_v1/Noise.h5"
# args["HUMAN_NOISE_FILE"] = "LRS2/mvlrs_v1/HumanNoise.h5"
args["NOISE_FILE"] = "LRS3/Noise.h5"
args["HUMAN_NOISE_FILE"] = "LRS3/HumanNoise.h5"
...
"""
#args["GPU_IDS"] = [0,1,2,3] #[ 0,1,2,3]
args["GPU_IDS"] = [0,1,2,3,4,5,6,7] #[ 0,1,2,3]
args["GPU_ID"] = [0]
args["NUM_WORKERS"] = 4  # 4*GPU？
args["NUM_CPU_CORE"] = 2
args["BATCH_SIZE"] = 14    # 8？    一张卡：8，12  3张卡：12 12 （gpu挺满的） 但是很慢 准备试试 8，12
