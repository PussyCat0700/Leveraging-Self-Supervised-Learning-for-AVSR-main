...
"""
args["GPU_IDS"] = [0,1] #[ 0,1,2,3]
#args["GPU_IDS"] = [0,1,2,3,4,5,6,7] #[ 0,1,2,3]
args["GPU_ID"] = [0]
args["NUM_WORKERS"] = 4  # 4*GPU？
args["NUM_CPU_CORE"] = 2
args["BATCH_SIZE"] = 64   # 8？    一张卡：8，12  3张卡：12 12 （gpu挺满的） 但是很慢 准备试试 8，12    AV四卡12 13，14min左右
...
args["TRAIN_LRS2_MODEL_FILE"] = "/home/gryang/Leveraging-Self-Supervised-Learning-for-AVSR-main/check923/train-step_0184-wer_0.062.ckpt" #"/home/gryang/Leveraging-Self-Supervised-Learning-for-AVSR-main/check914/train-step_0158-wer_0.064.ckpt"
...
args["LAMBDA"] = 0.1
args["BEAM_WIDTH"] = 5
args["TEST_WITH_NOISE"] = True#False
...
args["PE_MAX_LENGTH"] = 500  # length up to which we calculate positional encodings   LRS3 500不够长  904
