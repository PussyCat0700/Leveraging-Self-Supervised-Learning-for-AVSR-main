...
#SBATCH --output=eval_hybrid_VO.out
#SBATCH --error=eval_hybrid_VO.err
...
--modal VO \
--decode_type HYBRID \
--logname /data1/yfliu/Leveraging-Self-Supervised-Learning-for-AVSR-main_noneed/beam40_VO/vo_hyb.txt \
--beamWidth 40 \
--batch_size 48 \
--beta 0.8 \
--nbest 30